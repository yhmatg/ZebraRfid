...
public class PreFilter1ContentFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (Application.singulationControl != null)
            ((Spinner) getActivity().findViewById(R.id.preFilterTarget)).setSelection(Application.singulationControl.getSession().getValue());
    ...
    public static boolean setSingulation(boolean nonmatching, boolean restore) {
        ...
        try {
            ...
            if(restore)
            {
                if(Application.ActiveProfile.content.equals("Fastest Read"))
