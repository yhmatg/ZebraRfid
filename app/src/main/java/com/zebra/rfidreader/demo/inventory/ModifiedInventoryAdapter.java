...
public class ModifiedInventoryAdapter extends ArrayAdapter<InventoryListItem> {
    ...
    public synchronized View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (Application.TAG_LIST_MATCH_MODE && Application.SHOW_CSV_TAG_NAMES && !holder.getCsvTagDetailsView().getText().equals("unknown")) {
            CharSequence temp = holder.getTextView().getText();
            holder.getTextView().setText(holder.getCsvTagDetailsView().getText());
