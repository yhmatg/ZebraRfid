...
import com.zebra.rfidreader.nonghang.reader_connection.PasswordDialog;
import com.zebra.rfidreader.nonghang.reader_connection.ReadersListFragment;

import static com.zebra.rfidreader.nonghang.home.MainActivity.isAppIsInBackground;

/**
 * Class to handle the UI for setting details like antenna config, singulation etc..
 * Hosts a fragment for UI.
 */
public class SettingsDetailActivity extends AppCompatActivity implements ResponseHandlerInterfaces.ReaderDeviceFoundHandler, Readers.RFIDReaderEventHandler, ResponseHandlerInterfaces.BatteryNotificationHandler,  AdvancedOptionItemFragment.OnAdvancedListFragmentInteractionListener {
