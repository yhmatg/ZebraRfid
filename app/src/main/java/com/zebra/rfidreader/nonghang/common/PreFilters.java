...
public class PreFilters {
    ...
    /**
     * Constructor of the {@link com.zebra.rfidreader.nonghang.common.PreFilters}
     *  @param tag             tag id
    ...
    public PreFilters(com.zebra.rfid.api3.PreFilters.PreFilter preFilterData){
        ...
        int action = preFilterData.getFilterAction().ordinal;
        int target = preFilterData.StateAwareAction.getTarget().ordinal;
        this.setTag(tag);
